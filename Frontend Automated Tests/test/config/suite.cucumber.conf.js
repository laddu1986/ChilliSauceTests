...
exports.config = {
    ...
    connectionRetryTimeout: defaultTimeoutInterval,    // Default timeout in milliseconds for request  if Selenium Grid doesn't send response
    connectionRetryCount: 3,          // Default request retries count

    /*services: ['browserstack'],
    user: process.env.eldercerrato3,
    key: process.env.nTnrxYTqE7C7bNzZyTrG,
  ...
  //seleniumLogs: '../test/selenium-logs',
    ...
    cucumberOpts: {
        ...
        require: [
                  './test/stepDefinitions/login.js',
                  // './test/stepDefinitions/loginstepssocialmedia.js',
                  // './test/stepDefinitions/loginstepswrongcredentials.js',
                  // './test/stepDefinitions/loginstepsnocredentials.js'
                  ],
        ...
        //tagExpression: '@successful-login, not @Pending',      // <string> (expression) only execute the features or scenarios with tags matching the expression, see https://docs.cucumber.io/tag-expressions/
        tagExpression: 'not (@unsuccessfullogin.wrongcredentials or @unsuccessfullogin.nocredentials)',
